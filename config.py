...
opt_arg.add_argument('--lr', type=float, default=1e-6)
...
if dataset == '3DMatch':
    ...
    data_arg.add_argument('--root', type=str, default='./dataset/kitti')
...
misc_arg.add_argument('--gpu_num', type=int, default=0)
misc_arg.add_argument('--verbose', type=str2bool, default=True)
misc_arg.add_argument('--pretrain', type=str, default='') #./snapshot/leading_eigenvector_fpfh/models/model_best.pkl
